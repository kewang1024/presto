...
public class TestHttpRequestSessionContext
{
    ...
    public void testAdditionalSessionProperty()
    {
        ...
        Map<String, String> prism_session_property = new HashMap<>();
        prism_session_property.put("node_selection", "SOFT_AFFINITY");
        prism_session_property.put("orc_compression_codec", "ZSTD");
        assertEquals(
                context.getCatalogSessionProperties(),
                ImmutableMap.builder()
                    .put("prism", prism_session_property)
                    .build());
        assertEquals(
