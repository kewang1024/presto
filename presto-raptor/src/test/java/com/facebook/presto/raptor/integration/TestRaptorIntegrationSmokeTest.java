        ...
        extends AbstractTestIntegrationSmokeTest
{
    ...
    public void testTableProperties()
    {
        ...
        computeActual("CREATE TABLE test_table_properties_3 (foo BIGINT, bar BIGINT, ds DATE) WITH (DELTA_DELETE_ENABLED=false)");
        computeActual("CREATE TABLE test_table_properties_4 (foo BIGINT, bar BIGINT, ds DATE) WITH (delta_delete_enabled=true)");
    }
    ...
    public void testShowCreateTable()
    {
        ...
        // For delta_delete_enabled, we don't have null value, thus can't distinguish between user set false and default false
        // As a result, will always show delta_delete_enabled properties when `SHOW CREATE TABLE`
        createTableSql = format("" +
                        "CREATE TABLE %s.%s.%s (\n" +
                        "   \"c\"\"1\" bigint,\n" +
                        "   c2 double,\n" +
    ...
    public void testTablesSystemTable()
    {
        ...
        assertUpdate("" +
                ...
                "WITH (ordering = ARRAY['c61', 'c62'], distribution_name = 'test_distribution', bucket_count = 50, bucketed_on = ARRAY ['c63', 'c64'], organized = true, delta_delete_enabled = true)");
        ...
        assertEquals(
                ...
                ImmutableList.builder()
                        ...
                        .add(BOOLEAN) // delta_delete_enabled
                        .build());
    ...
    {
        // create empty table
        assertUpdate("CREATE TABLE test_table_stats (x bigint) WITH (delta_delete_enabled = true)");
    ...
    {
        assertUpdate("CREATE TABLE test_delta_delete_table (c1 bigint, c2 bigint) WITH (delta_delete_enabled = true)");
