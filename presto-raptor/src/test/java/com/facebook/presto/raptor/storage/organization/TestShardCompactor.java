...
public class TestShardCompactor
{
    ...
    {
        return storageManager.getPageSource(uuid, deltaShardUuid, tableSupportsDeltaDelete, OptionalInt.empty(), columnIds, columnTypes, TupleDomain.all(), READER_ATTRIBUTES);
    }
