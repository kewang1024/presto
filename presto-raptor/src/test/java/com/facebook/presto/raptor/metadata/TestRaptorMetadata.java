...
public class TestRaptorMetadata
{
    ...
    {
        assertNull(metadata.getTableHandle(SESSION, DEFAULT_TEST_ORDERS));
        metadata.createTable(SESSION, buildTable(ImmutableMap.of(DELTA_DELETE_PROPERTY, false), tableMetadataBuilder(DEFAULT_TEST_ORDERS)
    ...
    public void testTablePropertiesDeltaDelete()
    {
        ...
        assertTrue(metadataDao.getTableInformation(tableId).isDeltaDeleteEnabled());
    ...
    {
        assertNull(metadata.getTableHandle(SESSION, DEFAULT_TEST_ORDERS));
        metadata.createTable(SESSION, getOrdersTable(ImmutableMap.of(ORGANIZED_PROPERTY, true, DELTA_DELETE_PROPERTY, false)), false);
    }
    ...
    public void testSortOrderProperty()
    {
        ...
        ConnectorTableMetadata ordersTable = getOrdersTable(ImmutableMap.of(ORDERING_PROPERTY,
                ImmutableList.of("orderdate", "custkey"), DELTA_DELETE_PROPERTY, false));
        metadata.createTable(SESSION, ordersTable, false);
    ...
    {
        return getOrdersTable(ImmutableMap.of(DELTA_DELETE_PROPERTY, false));
    }
