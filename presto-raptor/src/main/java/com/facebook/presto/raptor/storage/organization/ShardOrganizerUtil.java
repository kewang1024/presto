...
public class ShardOrganizerUtil
{
    ...
    static OrganizationSet createOrganizationSet(long tableId, boolean deltaDeleteEnabled, Set<ShardIndexInfo> shardsToCompact)
    {
        ...
        return new OrganizationSet(tableId, deltaDeleteEnabled, uuidsMap, getOnlyElement(bucketNumber));
    }
}
