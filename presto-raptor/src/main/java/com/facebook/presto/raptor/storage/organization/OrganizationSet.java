...
public class OrganizationSet
{
    ...
    public OrganizationSet(long tableId, boolean deltaDeleteEnabled, Map<UUID, Optional<UUID>> shardsMap, OptionalInt bucketNumber)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        return tableId == that.tableId &&
                deltaDeleteEnabled == that.deltaDeleteEnabled &&
    ...
    public int hashCode()
    {
        return Objects.hash(tableId, deltaDeleteEnabled, shardsMap, bucketNumber);
    }
    ...
    public String toString()
    {
        return toStringHelper(this)
                .add("tableId", tableId)
                .add("deltaDeleteEnabled", deltaDeleteEnabled)
