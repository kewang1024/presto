...
import static com.facebook.presto.raptor.RaptorTableProperties.isDeltaDeleteEnabled;
        ...
        implements ConnectorMetadata
{
    ...
    public ConnectorTableMetadata getTableMetadata(ConnectorSession session, ConnectorTableHandle tableHandle)
    {
        ...
        properties.put(DELTA_DELETE_PROPERTY, handle.isDeltaDeleteEnabled());
    ...
    public ConnectorOutputTableHandle beginCreateTable(ConnectorSession session, ConnectorTableMetadata tableMetadata, Optional<ConnectorNewTableLayout> layout)
    {
        ...
        boolean deltaDeleteEnabled = isDeltaDeleteEnabled(tableMetadata.getProperties());
        if (organized) {
            if (temporalColumnHandle.isPresent()) {
    ...
    public Optional<ConnectorOutputMetadata> finishCreateTable(ConnectorSession session, ConnectorOutputTableHandle outputTableHandle, Collection<Slice> fragments, Collection<ComputedStatistics> computedStatistics)
    {
        ...
        long newTableId = runTransaction(dbi, (dbiHandle, status) -> {
            ...
            long tableId = dao.insertTable(table.getSchemaName(), table.getTableName(), true, table.isOrganized(), distributionId, updateTime, table.isDeltaDeleteEnabled());
        ...
        shardManager.createTable(newTableId, table.isDeltaDeleteEnabled(), columns, table.getBucketCount().isPresent(), temporalColumnId);
