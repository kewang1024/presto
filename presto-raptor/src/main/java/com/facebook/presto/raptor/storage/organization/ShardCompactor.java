...
public final class ShardCompactor
{
            ...
            throws IOException
    {
        uuidsMap.forEach((uuid, deltaUuid) -> {
            try (ConnectorPageSource pageSource = storageManager.getPageSource(uuid, deltaUuid, false, bucketNumber, columnIds, columnTypes, TupleDomain.all(), readerAttributes)) {
            ...
            throws IOException
    {
        ...
        try {
            uuidsMap.forEach((uuid, deltaUuid) -> {
                ConnectorPageSource pageSource = storageManager.getPageSource(uuid, deltaUuid, false, bucketNumber, columnIds, columnTypes, TupleDomain.all(), readerAttributes);
