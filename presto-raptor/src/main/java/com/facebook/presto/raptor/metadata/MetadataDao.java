...
public interface MetadataDao
{
    String TABLE_INFORMATION_SELECT = "" +
            "SELECT t.table_id, t.distribution_id, d.distribution_name, d.bucket_count, t.temporal_column_id, t.organization_enabled, t.delta_delete_enabled\n" +
            "FROM tables t\n" +
    ...
    @SqlUpdate("INSERT INTO tables (\n" +
            ...
            "  shard_count, delta_count, row_count, compressed_size, uncompressed_size, delta_delete_enabled)\n" +
            "VALUES (\n" +
            "  :schemaName, :tableName, :compactionEnabled, :organizationEnabled, :distributionId,\n" +
            "  :createTime, :createTime, 0,\n" +
            "  0, 0, 0, 0, 0, :deltaDeleteEnabled)\n")
    @GetGeneratedKeys
    long insertTable(
            @Bind("schemaName") String schemaName,
            @Bind("tableName") String tableName,
            ...
            @Bind("deltaDeleteEnabled") boolean deltaDeleteEnabled);
    ...
    @SqlQuery("SELECT table_id, schema_name, table_name, temporal_column_id, distribution_name, bucket_count, organization_enabled, delta_delete_enabled\n" +
            "FROM tables\n" +
