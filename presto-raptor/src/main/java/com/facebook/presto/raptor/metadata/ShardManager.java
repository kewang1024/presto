...
public interface ShardManager
{
     ...
     * Create a table.
     */
    void createTable(long tableId, boolean deltaDeleteEnabled, List<ColumnInfo> columns, boolean bucketed, OptionalLong temporalColumnId);
     ...
     * With deltaDeleteEnabled: Delete oldShardsUuids with their delta shards
     * Add newShards
     */
    void replaceShardUuids(long transactionId, boolean deltaDeleteEnabled, long tableId, List<ColumnInfo> columns, Map<UUID, Optional<UUID>> oldShardUuids, Collection<ShardInfo> newShards, OptionalLong updateTime);
