...
public class OriginalShardRewriter
        implements ShardRewriter
{
    ...
    Collection<Slice> rewriteShard(BitSet rowsToDelete)
    {
        ...
        OrcFileInfo info = orcStorageManager.rewriteFile(columns, input, output, rowsToDelete);
        ...
        ShardInfo shard = orcStorageManager.createShardInfo(newShardUuid, bucketNumber, output, nodes, rowCount, uncompressedSize);
